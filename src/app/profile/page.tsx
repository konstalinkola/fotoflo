			...
			<div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
				<div className="bg-white shadow-lg rounded-lg">
					...
					<div className="p-6 space-y-8">
						...
						<div>
							<h2 className="text-lg font-semibold text-gray-900 mb-4">Google Account</h2>
							<div className="space-y-4">
								<div className="flex items-center space-x-3">
									...
									<span className="text-sm text-gray-700">
										{user.app_metadata?.provider === "google" ? "Linked to Google account" : "Not linked to Google account"}
									</span>
								</div>
								...
								<Button
									...
									className="w-full sm:w-auto"
								>
									{loading ? "Linking..." : user.app_metadata?.provider === "google" ? "Re-link Google Account" : "Link Google Account"}
								</Button>
							</div>
						</div>
