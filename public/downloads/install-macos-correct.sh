...
echo "🚀 Installing Fotoflo Desktop Sync (Correct API Version)..."
echo ""
...
# Create the correct sync script
cat > "$APP_DIR/fotoflo-sync.sh" << 'EOF'
#!/bin/bash

# Fotoflo Desktop Sync Script - Correct API Version
...
echo ""
echo "💡 This version fixes the API call format!"
